 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 package org.mangui.osmf.plugins {
	...
	ExternalInterface.call("console.log","HLSMediaElement constructor called");
            _hls = hls;
	...
	ExternalInterface.call("console.log","HLSMediaElement->createVideo()");
            return new Video();
        }

        override protected function createLoadTrait(resource : MediaResourceBase, loader : LoaderBase) : LoadTrait {
	ExternalInterface.call("console.log","HLSMediaElement->createLoadTrait()");
	...
	ExternalInterface.call("console.log","HLSMediaElement->processLoadingState()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSMediaElement->processReadyState() ");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSMediaElement->processUnloadingState()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSMediaElement->get smoothing()");
            return _smoothing;
        }

        public function set smoothing(value : Boolean) : void {
	ExternalInterface.call("console.log","HLSMediaElement->set smoothing()");
            _smoothing = value;
            if (videoSurface != null) {
	...
	ExternalInterface.call("console.log","HLSMediaElement->initTrait()");
            _stream = _hls.stream;
	...
	ExternalInterface.call("console.log","HLSMediaElement streamType varibale value :"+ streamType);
