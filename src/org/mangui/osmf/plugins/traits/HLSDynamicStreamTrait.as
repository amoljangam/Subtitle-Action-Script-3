 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 package org.mangui.osmf.plugins.traits {
	...
	ExternalInterface.call("console.log","HLSDynamicStreamTrait constructor");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log"," HLSDynamicStreamTrait->dispose");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log"," HLSDynamicStreamTrait->getBitrateForIndex()");
		...
		ExternalInterface.call("console.log","HLSDynamicStreamTrait->switchTo()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log"," HLSDynamicStreamTrait->autoSwitchChangeStart()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSDynamicStreamTrait->switchChangeStart()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log"," HLSDynamicStreamTrait->levelSwitchHandler()");
