 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 package org.mangui.osmf.plugins.traits {
	...
	ExternalInterface.call("console.log","HLSDisplayObjectTrait constructor()");	
            CONFIG::LOGGING {
	    ...
	    ExternalInterface.call("console.log","value of HLS and videoSurface:"+_hls + this.videoSurface);
	...
	ExternalInterface.call("console.log","HLSDisplayObjectTrait->dispose()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","oHLSDisplayObjectTrait->onStage()");
	...
	ExternalInterface.call("console.log","HLSDisplayObjectTrait->onFrame()");
