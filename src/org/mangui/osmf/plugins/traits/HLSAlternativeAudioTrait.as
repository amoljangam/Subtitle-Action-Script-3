...
package org.mangui.osmf.plugins.traits {
	...
	ExternalInterface.call("console.log","HLSAlternativeAudioTrait constructor");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","dispose() HLSAlternativeAudioTrait");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSAlternativeAudioTrait->numAlternativeAudioStreams()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSAlternativeAudioTrait->getItemForIndex()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSAlternativeAudioTrait->endSwitching*&*&*&*&*&*&*&*");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSAlternativeAudioTrait->executeSwitching()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSAlternativeAudioTrait->audioTrackChangedHandler()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log"," HLSAlternativeAudioTrait->audioTrackListChangedHandler()");
            CONFIG::LOGGING {
