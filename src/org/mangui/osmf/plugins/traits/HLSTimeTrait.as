 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 package org.mangui.osmf.plugins.traits {
	...
	ExternalInterface.call("console.log","HLSTimeTrait constructor");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSTimeTrait->dispose()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSTimeTrait->mediaTimeHandler()");
