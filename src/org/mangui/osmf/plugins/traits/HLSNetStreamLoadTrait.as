 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 package org.mangui.osmf.plugins.traits {
	...
	ExternalInterface.call("console.log","HLSNetStreamLoadTrait constructor");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log"," HLSNetStreamLoadTrait->dispose()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSNetStreamLoadTrait->mediaTimeHandler()");
