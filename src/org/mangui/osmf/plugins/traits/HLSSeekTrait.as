 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 package org.mangui.osmf.plugins.traits {
	...
	ExternalInterface.call("console.log","HLSSeekStates constructor");
            CONFIG::LOGGING {
		...
		ExternalInterface.call("console.log","HLSSeekStates->dispose()");
            CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSSeekStates->seekingChangeStart()");
            if (newSeeking) {
                CONFIG::LOGGING {
	...
	ExternalInterface.call("console.log","HLSSeekStates->stateChangedHandler()");
