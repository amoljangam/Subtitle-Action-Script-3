...
package org.mangui.osmf.plugins.loader {
   ...
   public class HLSLoadFromDocumentElement extends ProxyElement {
	...
	ExternalInterface.call("console.log","HLSLoadFromDocument");
            if (loader == null) {
	...
	ExternalInterface.call("console.log","set resource");
	...
	ExternalInterface.call("console.log","onLoadStateChange function");
		...
		ExternalInterface.call("console.log","onProxiedElementLoadStateChange");
