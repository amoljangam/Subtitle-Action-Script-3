 ...
 package org.mangui.osmf.plugins.loader {
	...
	var urlResource : URLResource = URLResource(resource);
	        //  check for m3u/m3u8
	            ...
	            ExternalInterface.call("console.log","AAAA Recieved .m3u8 file");
                    return true;
                }
	...
	ExternalInterface.call("console.log","executeLoad");
	...
	ExternalInterface.call("console.log","HLSLoadBase->executeUnload()");
	...
	ExternalInterface.call("console.log","retrive stream type");
	...
	ExternalInterface.call("console.log","level2label");
            if (level.name) {
                return level.name;
            } else {
                if (level.height) {
