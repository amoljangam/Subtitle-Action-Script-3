...
package org.mangui.hls.playlist {
	...
	ExternalInterface.call("console.log","$$$$$$function loadPlaylist is called..");
            _url = url;
            _success = success;
            _index = index;
...
//comment added to check file....
	    ExternalInterface.call("console.log","this is data string::" + data);
	    // fragment seqnum
            var seqnum : int = 0;
